from transformer.pnml.pnml import Net, Place
...
def split_different_operators(net: Net):
    ...
    wf_operators = [
        ...
        if x.t in {WorkflowBranchingType.AndJoinXorSplit, WorkflowBranchingType.XorJoinAndSplit}
    ]
    for o in wf_operators:
        ...
        if o.t == WorkflowBranchingType.AndJoinXorSplit:
            add_wf_and_join(net=net, id="AND" + o.id, name=o.name, out_place=p, in_places=list(o.incoming_nodes))
            add_wf_xor_split(net=net, id="XOR" + o.id, name=o.name, in_place=p, out_places=list(o.outgoing_nodes))
        elif o.t == WorkflowBranchingType.XorJoinAndSplit:
            add_wf_xor_join(net=net, id="XOR" + o.id, name=o.name, out_place=p, in_places=list(o.incoming_nodes))
            add_wf_and_split(net=net, id="AND" + o.id, name=o.name, in_place=p, out_places=list(o.outgoing_nodes))
        else:
