...
from transformer.pnml.pnml import Arc, Net
...
def petri_net_type_map(pn: Net):
    return create_type_dict([*pn.transitions, *pn.places, *pn.arcs], petri_net_element_to_comp_value)
