...
class TestE2EPostTransform(unittest.TestCase):
    ...
    def test_pnml_to_bpmn(self):
        ...
        bpmn_xml = '../../diagrams/xml/e2e_bpmn_res'
        with open(bpmn_xml, encoding='utf-8') as file:
            bpmn_string = file.read()
        pnml_xml = '../../diagrams/xml/e2e_pnml_req'
    ...
    def test_bpmn_to_pnml(self):
        ...
        payload = {
            "bpmn": (
                ...
                "xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:bpmn=\""
                "http://www.omg.org/spec/BPMN/20100524/MODEL\" xmlns:bpmndi=\"http://"
                "www.omg.org/spec/BPMN/20100524/DI\" xmlns:dc=\"http://www.omg.org/"
                "spec/DD/20100524/DC\" xmlns:di=\"http://www.omg.org/spec/DD/20100524/"
                "DI\" id=\"Definitions_0uh33yr\" targetNamespace=\"http://bpmn.io/"
                "schema/bpmn\" exporter=\"bpmn-js (https://demo.bpmn.io)\" "
                "exporterVersion=\"17.6.2\"> <bpmn:process id=\"Process_05gf0wk\" "
                "isExecutable=\"false\"> <bpmn:startEvent id=\"StartEvent_1kldrri\"> "
                "<bpmn:outgoing>Flow_03wmhzd</bpmn:outgoing> </bpmn:startEvent> "
                "<bpmn:task id=\"Activity_16g2nsl\" name=\"Task\"> <bpmn:incoming>"
                "Flow_03wmhzd</bpmn:incoming> <bpmn:outgoing>Flow_06lknmg</bpmn:"
                "outgoing> </bpmn:task> <bpmn:sequenceFlow id=\"Flow_03wmhzd\" "
                ...
                "bpmn:process> <bpmndi:BPMNDiagram id=\"BPMNDiagram_1\"> <bpmndi:"
                "BPMNPlane id=\"BPMNPlane_1\" bpmnElement=\"Process_03gf0wk\"> <bpmndi"
                ":BPMNShape id=\"_BPMNShape_StartEvent_2\" bpmnElement=\"StartEvent_1"
                "kldrri\"> <dc:Bounds x=\"156\" y=\"82\" width=\"36\" height=\"36\" />"
                " </bpmndi:BPMNShape> <bpmndi:BPMNShape id=\"Activity_16g2nsl_di\" "
                "bpmnElement=\"Activity_16g2nsl\"> <dc:Bounds x=\"250\" y=\"60\" width"
                "=\"100\" height=\"80\" /> <bpmndi:BPMNLabel /> </bpmndi:BPMNShape> "
                "<bpmndi:BPMNShape id=\"Event_02tt0ub_di\" bpmnElement=\"Event_02tt0ub"
                "\"> <dc:Bounds x=\"412\" y=\"82\" width=\"36\" height=\"36\" /> </"
                "bpmndi:BPMNShape> <bpmndi:BPMNEdge id=\"Flow_03wmhzd_di\" bpmnElement"
                "=\"Flow_03wmhzd\"> <di:waypoint x=\"192\" y=\"100\" /> <di:waypoint x="
                "\"250\" y=\"100\" /> </bpmndi:BPMNEdge> <bpmndi:BPMNEdge id=\"Flow_06"
                "lknmg_di\" bpmnElement=\"Flow_06lknmg\"> <di:waypoint x=\"350\" y=\"10"
                "0\" /> <di:waypoint x=\"412\" y=\"100\" /> </bpmndi:BPMNEdge> </bpmnd"
                "i:BPMNPlane> </bpmndi:BPMNDiagram> </bpmn:definitions>"
            )
        }
        response = requests.post(
